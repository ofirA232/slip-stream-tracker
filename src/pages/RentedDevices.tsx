...
const RentedDevices: React.FC = () => {
  ...
  const rentedDevices = devices.filter(
    (device) => device.removalReason === "rental" &&
    (searchTerm === "" || 
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-right">רשימת מכשירים בהשכרה</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
